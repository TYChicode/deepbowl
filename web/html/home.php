    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"> <a class="nav-link" href="../html/home.php">電影介紹<span class="sr-only">(current)</span></a> </li>
                ...
                <div class="container">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="../html/movie_introduce/冰雪奇緣.php" style="text-decoration:none;color: black;">
                                ...
                                <td>
                                    <a href="../html/movie_introduce/安眠醫生.php" style="text-decoration:none;color: black;">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="../html/movie_introduce/尖峰人生暫停一下.php" style="text-decoration:none;color: black;">
                                        <img src="../img/尖峰人生暫停一下.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>尖峰人生暫停一下</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/情書.php" style="text-decoration:none;color: black;">
                                        <img src="../img/情書.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>情書</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/我的蛋糕師情人.php" style="text-decoration:none;color: black;">
                                        <img src="../img/我的蛋糕師情人.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>我的蛋糕師情人</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/是誰在造神.php" style="text-decoration:none;color: black;">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="../html/movie_introduce/樓下的房客.php" style="text-decoration:none;color: black;">
                                        <img src="../img/樓下的房客.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>樓下的房客</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/殺手保鑣.php" style="text-decoration:none;color: black;">
                                        <img src="../img/殺手保鑣.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>殺手保鑣</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/返校.php" style="text-decoration:none;color: black;">
                                        <img src="../img/返校.jpg" class="img-responsive center-block" alt="Cinque Terre" width="256" height="192">
                                        <h3>返校</h3>
                                    </a>
                                </td>
                                <td>
                                    <a href="../html/movie_introduce/特種部隊.php" style="text-decoration:none;color: black;">
