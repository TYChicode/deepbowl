        ...
        <div class="container">
            <div class="row">
                <div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="text-decoration:none;color: black;">
                                        <h3>殺手保鑣</h3>
                                        <h5>演員 : 萊恩·雷諾斯、山繆·傑克森、蓋瑞·歐德曼、艾洛蒂·袁、莎瑪·海耶克</h5>
                                        <h5>導演 : 派屈克·休斯</h5>
                                        <h5>發片公司 : 獅門</h5>
                                        <h5>電影分級 : </h5>
                                        <h5>類型 : 喜劇/動作</h5>
                    ...
                    <h3>劇情簡介</h3>
                    <h5>‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾</h5>
                    <iframe width="900" height="506" src="https://www.youtube.com/embed/_3DScc5paVg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div>
                        <a>文字簡介</a>
                        <a>故事敘述白俄羅斯前總統杜霍維奇，被國際法院控告屠殺無辜民眾，一名職業殺手達留士則掌握了杜霍維奇下令屠殺的關鍵證據。於是達留士將被國際刑警組織與法國國家警察干預隊押送到，位在荷蘭的聯合國國際法院，要指控杜霍維奇。可是杜霍維奇為了阻止他，命令他一直祕密養著的一群非官方承認的白羅斯國家安全委員會殺手團隊設法殺害達留士。在國際刑警組織押送達留士到機場途中，刑警組織的內鬼洩漏了達留士的位置，使委員會的殺手團隊可以偷偷擊殺達留士，可是失敗而回。達留士和愛蜜利亞逃到現場附近的安全屋。達留士告訴愛蜜利亞局中一定有內鬼，現正只能找局外人幫忙保護他。愛蜜利亞於是找來她的前男友，前世界頭號的保鏢麥可。但麥可和達留士過去曾因彼此的職業起過衝突，麥可甚至還因此失去信用、幾乎為此失去工作。在愛蜜利亞的要求下，兩人必須把他們的紛爭放在一邊，以共同努力、化解危機。途中達留士和麥可增進彼此感情，達留士還幫助麥可化解他跟愛蜜利亞的矛盾。</a>
                    </div>
                </div>
            </div>
        </div>
